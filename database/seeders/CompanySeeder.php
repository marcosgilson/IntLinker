...
class CompanySeeder extends Seeder
{
    public function run(): void
    {
        $companies = [
            ...
            ['name' => 'Telefonica Espana',           'city' => 'Madrid',                     'description' => 'Operadora de telecomunicaciónes lider en Espana.',                          'applications_email' => 'talento@telefonica.com'],
            ...
            ['name' => 'Banco Santander',             'city' => 'Boadilla del Monte, Madrid', 'description' => 'Entidad financiera global con sede en Boadilla del Monte.',                 'applications_email' => 'selección@santander.com'],
            ...
            ['name' => 'Accióna',                     'city' => 'Alcobendas, Madrid',         'description' => 'Grupo en infraestructuras, energia renovable y agua.',                      'applications_email' => 'rrhh@accióna.com'],
            ...
            ['name' => 'Prosegur',                    'city' => 'Madrid',                     'description' => 'Empresa de seguridad privada y gestión de efectivo.',                       'applications_email' => 'empleo@prosegur.com'],
            ...
            ['name' => 'Cellnex Telecom',             'city' => 'Barcelona',                  'description' => 'Operador lider de infraestructuras de telecomunicaciónes en Europa.',       'applications_email' => 'empleo@cellnex.com'],
            ['name' => 'Abertis Infraestructuras',    'city' => 'Barcelona',                  'description' => 'Gestión de autopistas de peaje en Espana y varios paises.',                 'applications_email' => 'rrhh@abertis.com'],
            ...
            ['name' => 'Aguas de Valencia',           'city' => 'Valencia',                   'description' => 'Empresa de gestión del ciclo integral del agua en Valencia.',               'applications_email' => 'rrhh@aguasdevalencia.es'],
            // ── Sevilla / Andalucia ───────────────────────────────────────────
            ...
            ['name' => 'Navantia',                    'city' => 'San Fernando, Cadiz',        'description' => 'Empresa publica de construccion naval y sistemas de defensa.',              'applications_email' => 'selección@navantia.es'],
            ...
            ['name' => 'R — Cable y Telecomunicaciónes', 'city' => 'A Coruna',               'description' => 'Operadora de telecomunicaciónes de referencia en Galicia.',                  'applications_email' => 'empleo@r.es'],
