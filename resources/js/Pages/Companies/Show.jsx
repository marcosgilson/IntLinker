        ...
        <>
            ...
            <div className="flex flex-col min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-indigo-950 via-indigo-900 to-violet-900 font-sans">
                <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm">
                    <div className="max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between gap-3">
                ...
                <div className="pt-20 sm:pt-24 pb-12 max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8 space-y-4 sm:space-y-5">
                    {/* Header card */}
