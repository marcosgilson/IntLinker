    ...
    return (
        <div className={`bg-white rounded-2xl border-2 ${cfg.ring} p-4 sm:p-5 flex flex-col gap-4 transition-shadow hover:shadow-md`}>
            ...
            {enrollment.status === 'waiting' && (
                <p className="text-sm text-gray-500">Tu postulación esta siendo revisada por la empresa.</p>
            )}
...
export default function EnrollmentsIndex({ enrollments = [], activeSlots = 0, maxSlots = 5 }) {
    ...
    return (
        <>
            <Head title="Mis postulaciónes — IntLinker" />
            ...
            <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-indigo-950 via-indigo-900 to-violet-900 font-sans">
                ...
                <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm">
                    <div className="w-full px-4 sm:px-6 lg:px-10 xl:px-16 h-14 sm:h-16 flex items-center justify-between">
                ...
                <div className="pt-20 sm:pt-24 pb-12 w-full px-4 sm:px-6 lg:px-10 xl:px-16">
                    {/* Header */}
                    <div className="mb-8">
                    ...
                    {active.length > 0 ? (
                        ...
                        <div className="text-center py-16 text-gray-300">
                            ...
                            <p className="text-lg font-medium">Sin postulaciónes activas</p>
